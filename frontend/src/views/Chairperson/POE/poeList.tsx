...
export default function PoeList() {
  ...
  return (
    <div>
      ...
      >
        <div className="mt-14 opacity-80 p-4 pb-10 shadow bg-white border-dashed rounded-lg relative">
          ...
          <div className="flex flex-col md:flex-row gap-4 ml-10 mt-6">
            <Button
              ...
              onClick={() => navigate("/chairperson/poe/create")}
            >
            ...
            <Button
              color="light"
              className="flex items-center gap-2 hover:scale-105 transition"
              onClick={() => navigate("/chairperson/poe/edit")}
            >
              <svg width="25" height="25" viewBox="0 0 24 24" fill="none">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="showDelete" className="font-semibold">
                Show Delete Button
              </label>
            </div>
          </div>
